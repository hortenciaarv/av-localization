...
class ControlNode(Node):
    ...
    def lineal_controller(self):
        ...
        # if(self.cmd_vel_msg.linear.x > 3):
        #     self.cmd_vel_msg.linear.x = 3.0
        # elif(self.cmd_vel_msg.linear.x < 0.0008):
    ...
    def angular_controler(self):
        ...
        # if(self.cmd_vel_msg.angular.z > 1):
        #     self.cmd_vel_msg.angular.z = 1.0
        # if(self.cmd_vel_msg.angular.z < 0.08):
