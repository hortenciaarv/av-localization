...
import math
import sys
sys.path.append('/home/ubuntu/puzzlebot_ws/src/localisation/scripts')
...
class ToGoalNode():
    ...
    def bug2_algorithm(self):
        print("bug2")
        while(self.ranges[270] >= 0.45 or self.ranges[180] <= 0.55):
            # print("bug2")
    ...
    def follow_wall(self):
        ...
        while(abs(self.y_pose - y_line) > 0.1 or self.distance_hit_point < self.distance_pose):
