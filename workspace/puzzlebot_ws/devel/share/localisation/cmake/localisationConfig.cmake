...
if("TRUE" STREQUAL "TRUE")
  set(localisation_SOURCE_PREFIX /root/workspace/puzzlebot_ws/src/localisation)
  set(localisation_DEVEL_PREFIX /root/workspace/puzzlebot_ws/devel)
  ...
  set(localisation_INSTALL_PREFIX /root/workspace/puzzlebot_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'localisation' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'localisation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/workspace/puzzlebot_ws/src/localisation/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT localisation_NUM_DUMMY_TARGETS)
      set(localisation_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::localisation::wrapped-linker-option${localisation_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR localisation_NUM_DUMMY_TARGETS "${localisation_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::localisation::wrapped-linker-option${localisation_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND localisation_LIBRARIES "${interface_target_name}")
...
set(localisation_EXPORTED_TARGETS "")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${localisation_dep}_FOUND)
      find_package(${localisation_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${localisation_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(localisation_EXPORTED_TARGETS ${${localisation_dep}_EXPORTED_TARGETS})
endforeach()
